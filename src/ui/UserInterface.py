...
"La idea fue propuesta por el físico mexicano Miguel Alcubierre en 1994 y ha inspirado tanto a científicos como a escritores de ciencia ficción."
    ...
    def plot_curvature(self):
        self.show_custom_info("Gráfica 1D", "Se mostrará una gráfica con la deformación del espacio-tiempo en una dimensión.")
        self.plots.plot_static_bubble()

    def plot_2d_field(self):
        self.show_custom_info("Mapa de curvatura 2D", "Se mostrará un campo de curvatura bidimensional.")
        self.plots.plot_2d_field()

    def animate_bubble(self):
        self.show_custom_info("Animación de burbuja", "Se iniciará la animación de la burbuja moviéndose por el espacio.")
        self.plots.animate_bubble_motion()
